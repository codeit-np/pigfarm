                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input required id="ref" class="form-control" type="text" name="ref" placeholder="eg. Supplier Bill No">
                                </div>
                            </div>
                        </div>
                        <div class="form-group my-2">
                            <label for="sub_category_id">Transaction on *</label>
                            <select required id="sub_category_id" class="form-control" name="sub_category_id">
                        ...
                        <div class="form-group">
                            ...
                            <input required id="amount" class="form-control" type="text" name="amount">
                        </div>
