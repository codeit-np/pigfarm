    ...
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <div class="card">
                        <img src="{{ asset('images/pig.jpg') }}" class="img-fluid" alt="">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img src="{{ asset('images/pig_income.jpg') }}" class="img-fluid" alt="">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img src="{{ asset('images/expanse1.jpg') }}" class="img-fluid" alt="">
